...
struct ContentView: View {
    ...
    @State private var numberOfPeopleValueIndex = 2
    ...
    var totalPerPerson: Double {
        let peopleCount = Double(numberOfPeopleValueIndex + 2)
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Picker("Number of people", selection: $numberOfPeopleValueIndex) {
                        ForEach(2..<100) {
                            Text("\($0) people" )
                        }
                    }
